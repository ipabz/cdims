	...
	$.fn.panorama = function(options) {
		this.each(function(){ 
			...
			panoramaContainer.css('height', elemHeight+'px').css('overflow', 'hidden').wrap("<div class='panorama-viewport'></div>").parent().css('width',settings.viewport_width+'px')
				.append("<div class='panorama-control'><a href='#' class='panorama-control-left'><img src='button/left.png' width='28' height='28' /></a> <a href='#' class='panorama-control-pause'><img src='button/iimage_panorama_stop.gif' width='28' height='28' /></a> <a href='#' class='panorama-control-right'><img src='button/right.gif' width='28' height='28' /></a> </div>");
